...
name: golang
description: >-
  Use when writing, modifying, refactoring, or reviewing Go (Golang) code,
  including tests. Apply the user's conventions for semicolons, error
  naming, shadowing, and ez errors.
---
